...
local_to_te_model_param_state_dict_map = {
    "input_norm.weight": "self_attention.linear_qkv.layer_norm_weight",
    ...
    "post_attention_norm.weight": "mlp.linear_fc1.layer_norm_weight",
...
def map_state_dict(model_state_dict, state_dict_map):
    if state_dict_map is not None:
        ...
        if 'embedding' in model_state_dict['language_model']:
            ...
            new_model_state_dict['decoder.final_layernorm.weight'] = model_state_dict['language_model']['encoder']['final_norm.weight']
